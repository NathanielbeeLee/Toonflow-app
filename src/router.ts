// @routes-hash d37922f70e53fe2a4e7706ad28f0e05d
...
import route37 from "./routes/generationTasks/list";
import route38 from "./routes/generationTasks/retry";
import route39 from "./routes/login/login";
...
export default async (app: Express) => {
  ...
  app.use("/api/generationTasks/list", route37);
  app.use("/api/generationTasks/retry", route38);
  app.use("/api/login/login", route39);
