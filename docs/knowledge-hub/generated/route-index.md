...
| 接口 | 功能 | 节点 |
| --- | --- | --- |
| POST /api/production/workbench/batchGenerateVideo | 持久批量视频任务 | feature.durable-video-batch |
| POST /api/generationTasks/list | 持久批量视频任务 | feature.durable-video-batch |
